...
$$text{where}\quad \sigma =\sqrt{\frac{2}{n_{in}+n_{out}}}\]\[n_{in}\]$$

(fan-in): The number of input units to the layer.\[n_{out}\] (fan-out): The number of output units from the layer. 
**He initialization**, 
