...
The Keras example requires significantly less code because Keras provides high-level abstractions for model construction, compilation, training, evaluation, 
